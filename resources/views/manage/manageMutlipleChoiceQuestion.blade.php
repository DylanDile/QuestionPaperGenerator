...
<div class="container">  
  <div class="card">
      <div class="card-header">         
          <center><h4> Manage Multiple Choice Question Details</h4></center>
          <hr>
      </div>
      <div class="card-body">
        {{-- Form Start --}}
              ...
              <div class="row">
                 <div class="col-sm-6">
                     {{-- Start form controls --}}
                        ...
                        <div class="col-md-6">
                            <input id="q_number" type="number" class="form-control @error('q_number') is-invalid @enderror" name="q_number" value="{{ old('q_number') }}" required autocomplete="q_number" autofocus>
